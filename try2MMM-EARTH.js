...
Module.register("MMM-EARTH", {
  ...
  getDom: function() {
    ...
    if (!this.loaded) {
      wrapper.innerHTML = "Getting your picture...<img src='modules/MMM-EARTH/loading/loading.gif' width='22' height='22'>";
    ...
    if (hkeys.length > 0) {
      ...
      var daily = moment().subtract2, "days").format('YYYY/MM/DD');
      if (earthImg != undefined) {
        ...
        earthPhoto.innerHTML = "https://epic.gsfc.nasa.gov/archive/natural/2016/07/05/jpg/'+earthImg+'.jpg"
