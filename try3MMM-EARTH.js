...
// if indeed there is one. 
    ...
    getDom: function() {
        ...
        earthPhoto.innerHTML = '<img src="https://epic.gsfc.nasa.gov/archive/natural/'+daily+'/jpg/'+earthImg+'.jpg"  width="'+this.config.MaxWidth+'" height="'+this.config.MaxHeight+'">';
         ...
         var static = this.static[hkeys[this.activeItem]];
        
			var staticImg = static.image;
			console.log(staticImg+".jpg");

        var staticPhoto = document.createElement("div");
        staticPhoto.innerHTML = '<img src="https://epic.gsfc.nasa.gov/archive/natural/2016/07/05/jpg/'+staticImg+'.jpg"  width="'+this.config.MaxWidth+'" height="'+this.config.MaxHeight+'">';
			}
    ...
    processSTATIC: function(data) { // I assume I need this because EARTH has one
        this.today = data;    // I want the date to be 2016-07-05 (therefore, static)
